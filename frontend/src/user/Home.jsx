...
const dummyRequests = [
  { id: 1, name: "Amit Sharma", location: "12.9716, 77.5946" },
  { id: 2, name: "Priya Singh", location: "28.7041, 77.1025" },
  { id: 3, name: "Raj Patel", location: "19.0760, 72.8777" },
];
        ...
        <header className="home-header">
          ...
          <div className="header-icons">
            <button className="notification-btn" onClick={handleNotificationClick} aria-label="Notifications">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="white" strokeWidth="2" viewBox="0 0 24 24" width="24" height="24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11c0-2.485-1.355-4.64-3.5-5.74V4a1.5 1.5 0 00-3 0v1.26C8.355 6.36 7 8.515 7 11v3.159c0 .538-.214 1.055-.595 1.436L5 17h5m5 0v1a3 3 0 01-6 0v-1m6 0H9" />
              </svg>
            </button>
            <button className="notification-btn" aria-label="Profile">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="white" strokeWidth="2" viewBox="0 0 24 24" width="50" height="50">
                <path strokeLinecap="round" strokeLinejoin="round" d="M5.121 17.804A8.966 8.966 0 0112 15c2.075 0 3.97.707 5.423 1.896M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
            </button>
          </div>
            ...
            <div className="notification-popup">
              ...
              <ul>
                {dummyRequests.map((req) => (
                  <li key={req.id} onClick={handleRequestClick}>
